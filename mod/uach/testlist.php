 ...
 * @access public
 */
class MoodleQuickForm_testlist extends MoodleQuickForm_selectgroups {
     ...
     * @return void
     */
    function MoodleQuickForm_testlist($elementName = null, $elementLabel = null, $options = null, $attributes = null) {
        ...
        if (is_array($options)) {
            ...
            $this->loadArrayOptGroups(
                        question_category_options($this->_options['contexts'], $this->_options['top'], $this->_options['currentcat'],
                                                false, $this->_options['nochildrenof'],true));
        }
    }
