...
if (isset($CFG->param_question_subjects[$COURSE->shortname])){
	echo '<a href="param_question_plugin/index.php?courseid='.$COURSE->id.'">Vložit parametrickou otázku</a>';
  echo '<br/>';
  echo '<a href="param_question_plugin/sablona.xlsx">Zde si můžete stáhnout šablonu pro Excel.</a>'   ;
}
echo "</div>\n";
